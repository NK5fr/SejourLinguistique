...
public class PlatformTest {
    ...
    public void testIndex(){
        ...
        pf.ajouter(t2);
        pf.ajouter(t3);
        assertEquals(0, pf.getIndexById(0));
        assertEquals(t2, pf.getById(1));
        pf.removeById(1);
        assertFalse(pf.getPromo().contains(t2));
    }

    @Test
    public void testNbCountry(){
        pf.ajouter(t1);
        pf.ajouter(t2);
        pf.ajouter(t3);
        assertEquals(2, pf.getNbCountry(Country.FRANCE));
        assertEquals(1, pf.getNbCountry(Country.SPAIN));
        pf.supprimer(t1);
        assertEquals(1, pf.getNbCountry(Country.FRANCE));
    }
}
