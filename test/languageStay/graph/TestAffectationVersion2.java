...
public class TestAffectationVersion2 {
    ...
    Affectations history2 = new Affectations();
        ...
        //exemple1
        t1 = new Teenager("Jack", "Grealish", LocalDate.of(1990, 12, 1), Country.GERMANY);
        t2 = new Teenager("Phil", "Foden", LocalDate.of(2000, 12, 1), Country.GERMANY);
        t3 = new Teenager("Harry", "Kane", LocalDate.of(1000, 12, 1), Country.GERMANY);
        t4 = new Teenager("Kyle", "Walker", LocalDate.of(1400, 12, 1), Country.GERMANY);
        t5 = new Teenager("Pedri", "Gonzalez", LocalDate.of(1500, 12, 1), Country.SPAIN);
        t6 = new Teenager("Nico", "Williams", LocalDate.of(1200, 12, 30), Country.SPAIN);
        t7 = new Teenager("David", "DeGea", LocalDate.of(1020, 12, 1), Country.SPAIN);
        t8 = new Teenager("Xavi", "Hernandez", LocalDate.of(1750, 12, 1), Country.SPAIN);
        ...
        //exemple2
        t11 = new Teenager("A", "Adonia", LocalDate.of(1990, 12, 1), Country.FRANCE);
        t12 = new Teenager("B", "Bellatrix", LocalDate.of(1750, 12, 1), Country.FRANCE);
        t13 = new Teenager("C", "Callista", LocalDate.of(2020, 12, 1), Country.FRANCE);
        t14 = new Teenager("X", "Xolag", LocalDate.of(2000, 12, 1), Country.SPAIN);
        t15 = new Teenager("Y", "Yak", LocalDate.of(1500, 12, 1), Country.SPAIN);
        t16 = new Teenager("Z", "Zander", LocalDate.of(1000, 12, 1), Country.SPAIN);
