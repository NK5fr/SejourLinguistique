...
public class AffectationUtil implements Serializable {
    public static final double INITIAL_WEIGHT = 10;
    public static final int REDHIBITOIRE = 1000;
    public static final int PREF = 2;

    public static double initialWeight = INITIAL_WEIGHT;
    public static int redhibitoire = REDHIBITOIRE;
    public static int pref = PREF;
    ...
    */
    public static double weight (Teenager host, Teenager visitor){
        ...
        if(host.birthdayPref(visitor) == true){
            result = result - pref*2;
        }
        return result;
    }
    ...
    public void setInitialWeight(double initialWeight) {
        AffectationUtil.initialWeight = initialWeight;
    }
    ...
    public void setRedhibitoire(int redhibitoire) {
        AffectationUtil.redhibitoire = redhibitoire;
    }
    ...
    public static List<Arete<Teenager>> affectation(List<Teenager> promo, Country guest, Country host){
        ...
        for(Teenager sommet1 : teenHost){
            for(Teenager sommet2 : teenGuest){
                if (!graphe.contientArete(sommet1, sommet2)) graphe.ajouterArete(sommet1, sommet2, AffectationUtil.weight(sommet1, sommet2));
            }
        }
    ...
    //     t2.addCriterion(CriterionName.PAIR_GENDER, "male");
